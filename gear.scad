...
module gear(
    ...
    gear2D(mm_per_tooth,number_of_teeth,hole_diameter,teeth_to_hide,
        pressure_angle,clearance,backlash,$fn=$fn);
}
...
module rack(
    ...
    rack2D(mm_per_tooth,number_of_teeth,height,pressure_angle,backlash);
}
